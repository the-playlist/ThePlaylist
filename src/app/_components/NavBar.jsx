...
const NavBar = () => {
  ...
  return (
    (masterViewTheme || !masterViewTheme) && (
      <nav
        className={`flex justify-between items-center px-5 py-3 drop-shadow ${masterViewTheme ? "bg-white" : "bg-light-tile"}  rounded-2xl`}
      >
        <div className="flex ">
          ...
          <div
            className={`${masterViewTheme ? " text-black" : "text-white"}  font-bold hover:cursor-pointer`}
          >
            {screenName[0]?.name || ""}
          </div>
        </div>

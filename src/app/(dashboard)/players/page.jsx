...
import { OptionButton, SongIcon, SongModal } from "../../_components";
...
const Players = async () => {
  ...
  return (
    <div>
              ...
              <tr className="h-20 text-black text-lg shadow-lg  rounded-2xl ">
                ...
                <td>
                  <div className="w-15 h-15">
                    <SongIcon
                      onClick={() => {
                        setAssignSongs(item?.assignSongs);
                ...
                <td>
                  <Menu
                    ...
                    transition
                  >
                    <MenuItem className={" justify-around"}>
                      <svg
                        width="16"
                        height="16"
                        viewBox="0 0 16 16"
      ...
      {<AddEditPlayer />}
      <SongModal title={"Songs"} item={assignSongs} />
    </div>
  );
};

...
//   let orderedSongs = [];
//   let remainingSongs = shuffleArray(songs);
...
//     // If no song can be placed without breaking the rules, reshuffle the remaining songs
//     if (!placed) {
//       remainingSongs = shuffleArray(remainingSongs);
//     }
//   }
...
//       // Skip if first song is Comedy category
//       if (orderedSongs.length === 0 && currentSong.category === "Comedy") {
//         continue;
//       }

//       // Ensure that the first song isn't from the most recent player
//       if (
//         orderedSongs.length === 0 &&
//         currentSong.playerName === mostRecentPlayerName
//       ) {
...
//       // Check placement rules to avoid consecutive same-player or consecutive Ballad songs
//       if (
//         (!lastSong || lastSong.playerName !== currentSong.playerName) &&
//         (!lastSong ||
//           lastSong.category !== "Ballad" ||
